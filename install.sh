yay -S zsh stow alacritty neovim \
    ...
    hyprland hyprpaper hyprshot hyprlock dunst brightnessctl xdg-desktop-portal-gtk xdg-desktop-portal-hyprland waybar wofi breeze breeze-gtk qt6ct qt5ct polkit-kde-agent \
